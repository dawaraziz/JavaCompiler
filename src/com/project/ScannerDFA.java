...
class ScannerDFA {
    ...
    static State BLOCK_COMMENT = new State("BLOCK_COMMENT", true, null);
    static State BLOCK_STAR = new State("BLOCK_STAR", true, null);
    ...
    static {
        ...
        String variable_chars = upper + lower + varsymbols + decNumbers;
        ...
        State FA = new State("FA", true, Kind.VARIABLE);
        State FAL = new State("FAL", true, Kind.VARIABLE);
        State FALS = new State("FALS", true, Kind.VARIABLE);
        State FALSE = new State("FALSE", true, Kind.FALSE);
        State TRU = new State("TRU", true, Kind.VARIABLE);
        State TRUE = new State("TRUE", true, Kind.TRUE);
        State NU = new State("NU", true, Kind.VARIABLE);
        State NUL = new State("NUL", true, Kind.VARIABLE);
        State NULL = new State("NULL", true, Kind.NULL);

        State VARSTATE = new State("varstate", true, Kind.VARIABLE);

        State ZERO = new State("zero", true, Kind.DECNUMINT);
        State HEXSTART = new State("hextart", false, null);

        State DECNUMINT = new State("decnumint", true, Kind.DECNUMINT);
        State DECNUMLONG = new State("decnumlong", true, Kind.DECNUMLONG);
        State OCTNUMINT = new State("octnumint", true, Kind.OCTNUMINT);
        State OCTNUMLONG = new State("octnumlong", true, Kind.OCTNUMLONG);
        State HEXNUMINT = new State("hexnumint", true, Kind.HEXNUMINT);
        State HEXNUMLONG = new State("hexnumlong", true, Kind.HEXNUMLONG);

        State WHITESPACE = new State("whitespace", true, null);

        State PAREN_OPEN = new State("(", true, Kind.PAREN_OPEN);
        State PAREN_CLOSE = new State(")", true, Kind.PAREN_CLOSE);
        State SQUARE_BRACKET_OPEN = new State("[", true, Kind.SQUARE_BRACKET_OPEN);
        State SQUARE_BRACKET_CLOSE = new State("]", true, Kind.SQUARE_BRACKET_CLOSE);
        State CURLY_BRACKET_OPEN = new State("{", true, Kind.CURLY_BRACKET_OPEN);
        State CURLY_BRACKET_CLOSE = new State("}", true, Kind.CURLY_BRACKET_CLOSE);

        State PLUS = new State("+", true, Kind.PLUS);
        State MINUS = new State("-", true, Kind.MINUS);
        State STAR = new State("*", true, Kind.STAR);
        State SLASH = new State("/", true, Kind.SLASH);
        State MODULUS = new State("%", true, Kind.MODULUS);
        State INCREMENT = new State("++", true, Kind.INCREMENT);
        State DECREMENT = new State("--", true, Kind.DECREMENT);
        State EQUAL = new State("=", true, Kind.EQUAL);
        State EQUALEQUAL = new State("==", true, Kind.EQUALEQUAL);
        State NOTEQUAL = new State("!=", true, Kind.NOTEQUAL);
        State GREATER = new State(">", true, Kind.GREATER);
        State LESS = new State("<", true, Kind.LESS);
        State GREATEREQUAL = new State(">=", true, Kind.GREATEREQUAL);
        State LESSEQUAL = new State("<=", true, Kind.LESSEQUAL);
        State AMPERSAND = new State("&", true, Kind.AMPERSAND);
        State BAR = new State("|", true, Kind.BAR);
        State AND = new State("&&", true, Kind.AND);
        State OR = new State("||", true, Kind.OR);
        State UPARROW = new State("^", true, Kind.UPARROW);
        State TILDE = new State("~", true, Kind.TILDE);
        State LEFTSHIFT = new State("<<", true, Kind.LEFTSHIFT);
        State RIGHTSHIFT = new State(">>", true, Kind.RIGHTSHIFT);
        State ZEROFILLRIGHTSHIFT = new State(">>>", true, Kind.ZEROFILLRIGHTSHIFT);
        State EXCLAMATION = new State("!", true, Kind.EXCLAMATION);
        State PLUSEQUAL = new State("+=", true, Kind.PLUSEQUAL);
        State MINUSEQUAL = new State("-=", true, Kind.MINUSEQUAL);
        State STAREQUAL = new State("*=", true, Kind.STAREQUAL);
        State SLASHEQUAL = new State("/=", true, Kind.SLASHEQUAL);
        State MODEQUAL = new State("%=", true, Kind.MODEQUAL);
        State LEFTSHIFTEQUAL = new State("<<=", true, Kind.LEFTSHIFTEQUAL);
        State RIGHTSHIFTEQUAL = new State(">>=", true, Kind.RIGHTSHIFTEQUAL);
        State AMPERSANDEQUAL = new State("&=", true, Kind.AMPERSANDEQUAL);
        State ARROWEQUAL = new State("^=", true, Kind.ARROWEQUAL);
        State BAREQUAL = new State("|=", true, Kind.BAREQUAL);
        State QUESTIONMARK = new State("?", true, Kind.QUESTIONMARK);
        State COLON = new State(":", true, Kind.COLON);

        State DOT = new State(".", true, Kind.DOT);
        State COMMA = new State(",", true, Kind.COMMA);

        State SEMICOLON = new State(";", true, Kind.SEMICOLON);

        State LINE_COMMENT = new State("LINE_COMMENT", true, null);
        State BLOCK_END = new State("BLOCK_END", true, null);

        State DOUBLE_DOT = new State("DOUBLE_DOT", false, null);
        State DOUBLENUM = new State("DOUBLENUM", true, Kind.DOUBLENUM);
        State DOUBLENUMEND = new State("DOUBLENUMEND", true, Kind.DOUBLENUM);
        State FLOATNUMEND = new State("FLOATNUMEND", true, Kind.FLOATNUM);
        State MINUSDOT = new State("MINUSDOT", false, null);
        State DOUBLEEXP = new State("DOUBLEEXP", false, null);
        State DOUBLEEXPMINUS = new State("DOUBLEEXPMINUS", false, null);
        State DOUBLEAFTEXP = new State("DOUBLEAFTEXP", true, Kind.DOUBLENUM);

        State CHARLIT = new State("CHARLIT", false, null);
        State CHAREND = new State("CHAREND", true, Kind.CHARLIT);
        State CHARESCP = new State("CHARESCP", false, null);

        State STRLIT = new State("STRLIT", false, null);
        State STREND = new State("STREND", true, Kind.STRLIT);
        State STRESCP = new State("STRESCP", false, null);

        START_STATE.addTransition(zero, ZERO);
        START_STATE.addTransition(notZeroNumbers, DECNUMINT);
