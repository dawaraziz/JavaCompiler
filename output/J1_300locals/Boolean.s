...
dd java.lang.Boolean_subtypeTable ; Pointer to the subtype table.
...
section .text ; Code for the method java.lang.Boolean_toString
java.lang.Boolean_toString:
...
add esp, 8
jmp java.lang.Boolean_toString@end_method

java.lang.Boolean_toString@end_method:
mov edi, [ebp - 12]
mov esi, [ebp - 8]
mov ebx, [ebp - 4]
...
section .text ; Code for the constructor java.lang.Boolean_Boolean
java.lang.Boolean_Boolean:
push ebp ; Saves the ebp.
mov ebp, esp ; Saves the esp.
push ebx
push esi
...
java.lang.Boolean_Boolean@end_method:
mov edi, [ebp - 12]
mov esi, [ebp - 8]
mov ebx, [ebp - 4]
mov esp, ebp ; Restores the esp.
...
section .text ; Code for the constructor java.lang.Boolean_Boolean_BOOLEAN
java.lang.Boolean_Boolean_BOOLEAN:
push ebp ; Saves the ebp.
mov ebp, esp ; Saves the esp.
push ebx
push esi
...
java.lang.Boolean_Boolean_BOOLEAN@end_method:
mov edi, [ebp - 12]
mov esi, [ebp - 8]
mov ebx, [ebp - 4]
mov esp, ebp ; Restores the esp.
