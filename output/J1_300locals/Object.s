...
global java.lang.Object_getClass
global java.lang.Object_clone
global java.lang.Object_hashCode
global java.lang.Object_toString
global java.lang.Object_equals_java.lang.Object
global java.lang.Object_Object
global java.lang.Object_vtable
section .data
java.lang.Object_vtable:
dd java.lang.Object_sitrow ; Pointer to the SIT.
dd java.lang.Object_subtypeTable ; Pointer to the subtype table.
...
section .text ; Code for the method java.lang.Object_getClass
java.lang.Object_getClass:
...
mov eax, 0
jmp java.lang.Object_getClass@end_method

java.lang.Object_getClass@end_method:
mov edi, [ebp - 12]
mov esi, [ebp - 8]
mov ebx, [ebp - 4]
...
section .text ; Code for the method java.lang.Object_clone
java.lang.Object_clone:
push ebp ; Saves the ebp.
mov ebp, esp ; Saves the esp.
push ebx
push esi
...
jmp java.lang.Object_clone@end_method

java.lang.Object_clone@end_method:
mov edi, [ebp - 12]
mov esi, [ebp - 8]
mov ebx, [ebp - 4]
mov esp, ebp ; Restores the esp.
...
section .text ; Code for the method java.lang.Object_hashCode
java.lang.Object_hashCode:
push ebp ; Saves the ebp.
mov ebp, esp ; Saves the esp.
push ebx
push esi
...
mov dword eax, 42
jmp java.lang.Object_hashCode@end_method

java.lang.Object_hashCode@end_method:
mov edi, [ebp - 12]
mov esi, [ebp - 8]
mov ebx, [ebp - 4]
mov esp, ebp ; Restores the esp.
...
section .text ; Code for the method java.lang.Object_toString
java.lang.Object_toString:
push ebp ; Saves the ebp.
mov ebp, esp ; Saves the esp.
push ebx
push esi
...
jmp java.lang.Object_toString@end_method

java.lang.Object_toString@end_method:
mov edi, [ebp - 12]
mov esi, [ebp - 8]
mov ebx, [ebp - 4]
mov esp, ebp ; Restores the esp.
...
section .text ; Code for the method java.lang.Object_equals_java.lang.Object
java.lang.Object_equals_java.lang.Object:
push ebp ; Saves the ebp.
mov ebp, esp ; Saves the esp.
push ebx
push esi
...
jmp java.lang.Object_equals_java.lang.Object@end_method

java.lang.Object_equals_java.lang.Object@end_method:
mov edi, [ebp - 12]
mov esi, [ebp - 8]
mov ebx, [ebp - 4]
mov esp, ebp ; Restores the esp.
...
section .text ; Code for the constructor java.lang.Object_Object
java.lang.Object_Object:
push ebp ; Saves the ebp.
mov ebp, esp ; Saves the esp.
push ebx
push esi
...
java.lang.Object_Object@end_method:
mov edi, [ebp - 12]
mov esi, [ebp - 8]
mov ebx, [ebp - 4]
mov esp, ebp ; Restores the esp.
